...
# ── Ticket-suggestion signal detection ──────────────────────────────────────────
# Used in Step 6 of run(): offer a ticket only when the query signals an unresolved
# problem, not a historical "how was X fixed" question.
